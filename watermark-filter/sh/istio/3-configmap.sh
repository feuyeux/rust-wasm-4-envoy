...
cd ../..
k delete configmap -n http-hello watermark-filter >/dev/null 2>&1
k create configmap -n http-hello watermark-filter --from-file=target/wasm32-unknown-unknown/release/watermark-filter.wasm
