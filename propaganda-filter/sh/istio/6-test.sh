...
echo "\n hello1 v2:"
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello1-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello1-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello1-svc:8001/hello/eric
echo "\n hello2 v2:"
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello2-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello2-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello2-svc:8001/hello/eric
echo "\n hello3 v2:"
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello3-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello3-svc:8001/hello/eric
echo
k -n http-hello exec "$hello3_v2_pod" -c hello-v2-deploy -- curl -s -H "version:v2" hello3-svc:8001/hello/eric